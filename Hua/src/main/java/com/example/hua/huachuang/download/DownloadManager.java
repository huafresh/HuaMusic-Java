...
package com.example.hua.huachuang.download;
...
import com.example.hua.huachuang.download.downloads.Downloads;
...
public class DownloadManager {
	...
	//等待中的状态
	public final static int STATUS_WAIT = 1 << 5;
	...
	public static DownloadManager getInstance(ContentResolver resolver, String packageName) {
		if(mDownloadManager==null) {
			mDownloadManager = new DownloadManager(resolver,packageName);
		}
